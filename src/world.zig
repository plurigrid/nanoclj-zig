...
fn demoEval(input: []const u8, env: *Env, gc: *GC, f: std.fs.File) void {
...
pub fn main() !void {
    ...
    // ── Header ──
    f.writeAll("\n\x1b[1;97m") catch {};
    f.writeAll("  nanoclj-zig: Clojure in ~5K lines of Zig\x1b[0m\n\n") catch {};

    // ── NaN-boxing diagram ──
    f.writeAll("\x1b[1m  NaN-boxing\x1b[0m (every value = one u64):\n") catch {};
    f.writeAll("  \x1b[90m┌─────┬──────────┬──┬────┬──────────────────────────────────────────┐\x1b[0m\n") catch {};
    f.writeAll("  \x1b[90m│\x1b[0msign \x1b[90m│\x1b[0m exponent \x1b[90m│\x1b[0mQ \x1b[90m│\x1b[0mtag \x1b[90m│\x1b[0m payload (48 bits)                      \x1b[90m│\x1b[0m\n") catch {};
    f.writeAll("  \x1b[90m└─────┴──────────┴──┴────┴──────────────────────────────────────────┘\x1b[0m\n") catch {};
    f.writeAll("  \x1b[90mtag: 0=nil 1=bool 2=i48 3=sym 4=kw 5=str 6=obj  (non-NaN = float)\x1b[0m\n\n") catch {};

    // ── Eval demos ──
    f.writeAll("\x1b[1m  Eval\x1b[0m (fuel-bounded, 1M steps max):\n") catch {};
    ...
    // ── GF(3) algebra ──
    f.writeAll("\x1b[1m  GF(3) algebra\x1b[0m (trit conservation: sum mod 3 = 0):\n") catch {};
    ...
    // ── Color strip ──
    f.writeAll("\x1b[1m  Color strip\x1b[0m (SplitMix64 seed=1069, GF(3) verified):\n") catch {};
    ...
    // ── Footer ──
    f.writeAll("  \x1b[90m21 modules | 5K LOC | MIT license | zig 0.15+\x1b[0m\n") catch {};
    f.writeAll("  \x1b[90mhttps://github.com/plurigrid/nanoclj-zig\x1b[0m\n\n") catch {};
}
