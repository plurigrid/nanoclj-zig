...
pub fn renderTritWheel(f: File, width: u32) !void {
    try f.writeAll("\x1b[1mGF(3) trit wheel\x1b[0m\n");
    const third = width / 3;
...
pub fn renderGapStrip(f: File, name_seed: u64, brain_seed: u64, width: u32) !void {
    try f.writeAll("\x1b[1mname-color vs brain-color gap\x1b[0m\n");
